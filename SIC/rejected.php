...
<div class="main">
  ...
  <button class="side_button" style="background-color: #006CFF"> <a href="#"> Rejected </a></button><br>
...
while ($rows = mysqli_fetch_array($exe)){
 ...
 ?>
    ...
    <td class="green"><a href="accept2.php?accept=<?php echo $reg; ?>&user=<?php echo $user; ?>">Accept</a></td>
