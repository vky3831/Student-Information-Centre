...
<div class="main">
  ...
  <button class="side_button" style="background-color: #006CFF"> <a href="#"> Semester Result </button></a><br>
...
<form>
	...
	<label for="subject" class="lab">Semester:</label>
	<select name="subject">
	...
	<button type="submit" name="button">show</button>
	</div>
